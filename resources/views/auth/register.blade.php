@if (env('APP_REG_ENABLED'))
    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group{{ $errors->has('reg_email') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="reg_email" type="reg_email" class="form-control" name="reg_email" value="{{ old('reg_email') }}" required>
        ...
        <div class="form-group{{ $errors->has('reg_password') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="reg_password" type="reg_password" class="form-control" name="reg_password" required>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="reg_password-confirm" type="reg_password" class="form-control" name="reg_password_confirmation" required>
            </div>
        </div>
